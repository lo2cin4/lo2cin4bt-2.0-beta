...
- `dataset_label`: backend-provided label for the dataset or run universe displayed by Parameter Matrix. Frontend should display this field when present and should not infer strategy meaning from filenames.
